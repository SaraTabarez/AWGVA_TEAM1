...
<main class="main">
    <section class="panel">
        ...
        <c:set var="cartaEnviada" value="${not empty documentoExistente
        ...
        <c:set var="cartaAceptada" value="${(not empty documentoExistente and fn:toUpperCase(documentoExistente.estado) == 'ACEPTADO')
            or estadoFlujo == 'CARTA_APROBADA_ESTADIAS'
            or estadoFlujo == 'OFICIO_GENERADO'
            or estadoFlujo == 'REPORTE_EN_REVISION'
            or estadoFlujo == 'REPORTE_RECHAZADO'
        ...
        <div class="stepper">
            ...
            <div class="step done"><div class="circle"><i class="bi bi-file-earmark-check"></i></div>Solicitud enviada</div>
            <div class="step done"><div class="circle"><i class="bi bi-patch-check"></i></div>Solicitud aceptada</div>
            <div class="step ${cartaEnviada ? 'done' : ''}"><div class="circle"><i class="bi bi-file-text"></i></div>Carta enviada</div>
            <div class="step ${cartaAceptada ? 'done' : ''}"><div class="circle"><i class="bi bi-patch-check"></i></div>Carta aceptada</div>
